...
class PrinterSettingsPage extends StatelessWidget {
          ...
          children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            ...
                            child: const Text(
                              'Test Print',
                              style: TextStyle(color: Color(0xFF5B3A1E)),
                            ),
                          ),
                          TextButton(
            ...
            Obx(() {
              if (printerService.printerType.value == PrinterType.escPos) {
                // Paper Size Settings for ESC/POS
                return _buildPaperSizeSettings(printerService);
              } else {
                // Label Size Settings for TSPL
            ...
            Obx(
              () => Text(
                'Mode: ${printerService.printerType.value == PrinterType.tspl ? "TSPL (Label)" : "ESC/POS (Receipt)"}',
                style: TextStyle(
                  color:
  ...
  Widget _labelSizeChip(PrinterService printerService, int width, int height, String label) {
    return Obx(() {
      final isSelected =
          printerService.labelWidth.value == width && printerService.labelHeight.value == height;
      return ChoiceChip(
        label: Text(label),
        selected: isSelected,
        onSelected: (selected) {
