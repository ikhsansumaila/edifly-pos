            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(order.tglOrder, style: TextStyle(fontSize: 10, color: Colors.grey.shade600)),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Text("${order.jumlahItem} Item", style: const TextStyle(fontSize: 11)),
                      ],
                    ),
                  ],
                ),
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(item.namaProduct, style: const TextStyle(fontSize: 13)),
                                Text(
                                  'x${item.qty}',
